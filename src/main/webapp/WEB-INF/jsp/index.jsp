    ...
    <div class="shangbanbu">
        ...
        <div class="row new-trends">
            ...
            <div class="col-lg-12 new-trends-content">
                <ul>
                    <li><img src="${pageContext.request.contextPath}/images/point.png" alt=""><a href="">艺术，每满150减50</a>
                    </li>
                    <li><img src="${pageContext.request.contextPath}/images/point.png" alt=""><a href="">一本好书，5折抢购！</a>
                    </li>
                    <li><img src="${pageContext.request.contextPath}/images/point.png" alt=""><a href="">当当出版，5折封顶！</a>
                    </li>
                </ul>
            </div>
        </div>
