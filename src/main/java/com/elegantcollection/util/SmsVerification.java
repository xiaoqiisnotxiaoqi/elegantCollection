...
public class SmsVerification {
    ...
    //配置您申请的KEY
    private static final String APPKEY ="763fcb79bc802d668ce81f89931b46ce";

    /**
     * 发送短信
     * @param phone 接收短信的手机号
     * @param tplId 短信模板id
     * @param tplValue 变量名和变量值对
     */
    public static void getRequest2(String phone,int tplId ,String tplValue){
        String result =null;
